...
def reconcile(bank_df, bb_df):
    ...
    for _, ar in bb_df.iterrows():
        ...
        if not match.empty:
            ...
            possible_name = fuzzy_match(ar['Statement Name'], counterparty_transactions['DESCRIPTION'].unique())
            print("Possible fuzzy match:", possible_name)
            match = counterparty_transactions[(counterparty_transactions['DESCRIPTION'] == possible_name) & (counterparty_transactions['AMOUNT'] == ar['Net Billed'])]
